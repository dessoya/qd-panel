...
eventProcessor.events.rule_bb_del_symbol = coroutine(function*(event, login_id, object_type_id, object_id, data, g) {
	...
	yield bridge_mysqlpool.query('delete from bb_rule where id = ' + line_id, g.resume)
